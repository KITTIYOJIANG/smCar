...
Build a small command consumer that reads planner JSON and prints each command in execution order.
After that, replace the print calls with real chassis functions.
